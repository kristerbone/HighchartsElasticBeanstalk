...
if (isset($typeString)) {
	...
	if (!file_put_contents("$tempDir/$tempName.svg", $svg)) { 
		die("Couldn't create temporary file. Check that the directory permissions for
			the /temp directory are set to 777.");
	}
	
	// do the conversion
	$output = shell_exec("java -jar ". BATIK_PATH ." $typeString -d $outfile $width $tempDir/$tempName.svg");
